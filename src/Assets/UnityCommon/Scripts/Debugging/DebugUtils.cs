...
namespace AltSrc.UnityCommon.Debugging
{
    /// <summary>
    /// Debug Utils
    ...
    public static class DebugUtils
    {
        ...
        /// </param>
        /// <param name='position'>
        ///   Where the center of the rectangle is positioned.
        /// </param>
        /// <param name='up'>
        ///   The up vector. Use this to orient the rectangle in the desired direction.
        /// </param>
        /// <param name='color'>
        ...
        /// </param>
        public static void DrawRect(float width, float height, Vector3 position, Vector3 up, Color color, float duration = 0, bool depthTest = true)
        {
            Vector3 tl = position + new Vector3(-width / 2f, 0f, height / 2f);
            Vector3 tr = position + new Vector3(width / 2f, 0f, height / 2f);
            Vector3 br = position + new Vector3(width / 2f, 0f, -height / 2f);
            Vector3 bl = position + new Vector3(-width / 2f, 0f, -height / 2f);

            Vector3 xr = Vector3.Cross(Vector3.right, up).normalized;
            Vector3 xf = Vector3.Cross(Vector3.forward, up).normalized;

            Quaternion look = new Quaternion();
            //look.SetLookRotation(position - new Vector3(width, 0f, 0f), up);
            look.SetLookRotation(xr.magnitude > 0f ? xr : xf, up);
            Matrix4x4 m = Matrix4x4.TRS(Vector3.zero, look, Vector3.one);
            tl = m.MultiplyPoint3x4(tl);
            tr = m.MultiplyPoint3x4(tr);
            br = m.MultiplyPoint3x4(br);
            bl = m.MultiplyPoint3x4(bl);
        ...
        public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
        {
            ...
            //Radial circles
            DebugUtils.DrawCircle(start, up, color, radius, duration, depthTest);	
            DebugUtils.DrawCircle(end, -up, color, radius, duration, depthTest);
            DebugUtils.DrawCircle((start+end)*0.5f, up, color, radius, duration, depthTest);
        ...
        public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
        {
            ...
            DebugUtils.DrawCircle(position+_forward, direction, color, (_forward-(slerpedVector.normalized*dist)).magnitude, duration, depthTest);
            DebugUtils.DrawCircle(position+(_forward*0.5f), direction, color, ((_forward*0.5f)-(slerpedVector.normalized*(dist*0.5f))).magnitude, duration, depthTest);
        }
        ...
        public static void DrawArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
        {
            ...
            DebugUtils.DrawCone(position+direction, -direction*0.333f, color, 15, duration, depthTest);
        }
        ...
        ///   The bounds to draw.
        /// </param>
        public static void GizmoBounds(Bounds bounds)
        {
            GizmoBounds(bounds, Color.white);
        }
        ...
        /// </param>
        public static void GizmoLocalCube(Transform transform, Vector3 size, Color color, Vector3 center = default(Vector3))
        {
            Color oldColor = Gizmos.color;
            Gizmos.color = color;
        ...
        ///	  The local position of the cube.
        /// </param>	
        public static void GizmoLocalCube(Transform transform, Vector3 size, Vector3 center = default(Vector3))
        {
            GizmoLocalCube(transform, size, Color.white, center);
        }
        ...
        ///   The color of the cube.
        /// </param>
        public static void GizmoLocalCube(Matrix4x4 space, Vector3 size, Color color, Vector3 center = default(Vector3))
        {
            Color oldColor = Gizmos.color;
            Gizmos.color = color;
        ...
        ///   The local position of the cube.
        /// </param>
        public static void GizmoLocalCube(Matrix4x4 space, Vector3 size, Vector3 center = default(Vector3))
        {
            GizmoLocalCube(space, size, Color.white, center);
        }
        ...
        ///   The radius of the circle.
        /// </param>
        public static void GizmoCircle(Vector3 position, Vector3 up, Color color, float radius = 1.0f)
        {
        ...
        ///   The radius of the circle.
        /// </param>
        public static void GizmoCircle(Vector3 position, Color color, float radius = 1.0f)
        {
            GizmoCircle(position, Vector3.up, color, radius);
        }
        ...
        ///   The radius of the circle.
        /// </param>
        public static void GizmoCircle(Vector3 position, Vector3 up, float radius = 1.0f)
        {
            GizmoCircle(position, position, Color.white, radius);
        }
        ...
        ///   The radius of the circle.
        /// </param>
        public static void GizmoCircle(Vector3 position, float radius = 1.0f)
        {
            GizmoCircle(position, Vector3.up, Color.white, radius);
        }
        ...
        ///   The radius of the cylinder.
        /// </param>
        public static void GizmoCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f){
            Vector3 up = (end-start).normalized*radius;
            Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
            Vector3 right = Vector3.Cross(up, forward).normalized*radius;
            
            //Radial circles
            DebugUtils.GizmoCircle(start, up, color, radius);	
            DebugUtils.GizmoCircle(end, -up, color, radius);
            DebugUtils.GizmoCircle((start+end)*0.5f, up, color, radius);
        ...
        ///   The radius of the cylinder.
        /// </param>
        public static void GizmoCylinder(Vector3 start, Vector3 end, float radius = 1.0f)
        {
            GizmoCylinder(start, end, Color.white, radius);
        }
        ...
        ///   The angle of the cone.
        /// </param>
        public static void GizmoCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
        {
            float length = direction.magnitude;
            ...
            DebugUtils.GizmoCircle(position+_forward, direction, color, (_forward-(slerpedVector.normalized*dist)).magnitude);
            DebugUtils.GizmoCircle(position+(_forward*0.5f), direction, color, ((_forward*0.5f)-(slerpedVector.normalized*(dist*0.5f))).magnitude);
        ...
        ///   The angle of the cone.
        /// </param>
        public static void GizmoCone(Vector3 position, Vector3 direction, float angle = 45)
        {
            GizmoCone(position, direction, Color.white, angle);
        }
        ...
        ///   The angle of the cone.
        /// </param>
        public static void GizmoCone(Vector3 position, Color color, float angle = 45)
        {
            GizmoCone(position, Vector3.up, color, angle);
        }
        ...
        ///   The angle of the cone.
        /// </param>
        public static void GizmoCone(Vector3 position, float angle = 45)
        {
            GizmoCone(position, Vector3.up, Color.white, angle);
        }
        ...
        {	
            ...
            DebugUtils.GizmoCone(position+direction, -direction*0.333f, color, 15);
        ...
        ///   The direction the arrow will point in.
        /// </param>
        public static void GizmoArrow(Vector3 position, Vector3 direction)
        {
            GizmoArrow(position, direction, Color.white);
        }
        ...
        ///   The radius of the capsule.
        /// </param>
        public static void GizmoCapsule(Vector3 start, Vector3 end, Color color, float radius = 1)
        {
            Vector3 up = (end-start).normalized*radius;
            Vector3 forward = Vector3.Slerp(up, -up, 0.5f);
            Vector3 right = Vector3.Cross(up, forward).normalized*radius;
        ...
        ///   The radius of the capsule.
        /// </param>
        public static void GizmoCapsule(Vector3 start, Vector3 end, float radius = 1)
        {
            GizmoCapsule(start, end, Color.white, radius);
        }
